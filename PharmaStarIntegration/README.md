...
#### Appendix #2 - Генератор на баркодове
 Примерен генератор на баркод по зададен идентификатор може да се намери тук: 
 ```https://erx2.e-health.bg/print/barcode/code128?code=ERX1592863105N00246А&scale=3```
Атрибута scale отговаря на размера на баркода, което пък от своя страна влияе върху качеството на изображението.

<img src="https://erx2.e-health.bg/print/barcode/code128?code=ERX1592863105N00246А&scale=3"/>
